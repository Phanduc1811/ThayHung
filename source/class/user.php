...
class user extends db
{
    ...
    function sendMail($emaill, $hoTen)
    {
        ...
        try {
            ...
            $mail->Username = 'phanducstu@gmail.com'; // SMTP username
            $mail->Password = 'kgalgaxfccacoczn';   // SMTP password
            $mail->SMTPSecure = 'ssl';  // encryption TLS/SSL 
            $mail->Port = 465;  // port to connect to                
            $mail->setFrom('phanducstu@gmail.com', 'Duck_D18_TH01');
            $mail->addAddress($emaill, $hoTen); //mail và tên người nhận  
            $mail->isHTML(true);  // Set email format to HTML
            $mail->Subject = 'THƯ THÔNG BÁO ĐĂNG KÝ TÀI KHOẢN THÀNH CÔNG';
            $noidungthu = '<h5>Bạn đã đăng ký tài khoản thành công tại website </h5> <p><a href="http://dh51800367.phanducstu.x10host.com/">Visit Me !! Come onnnnn</a></p>';
