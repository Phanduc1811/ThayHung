        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <input type="text" id="idbrand" name="DH51800367_mahang" required>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <input type="text" id="name" name="DH51800367_tenhang" required>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <input type="text" id="country" name="DH51800367_quocgia" required>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
