            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <input type="text" id="idbrand" name="DH51800367_mahang" value="<?php echo $db['idBrand'] ?>" required readonly/>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <input type="text" id="name" name="DH51800367_tenhang" value="<?php echo $db['nameBrand'] ?>" required />
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="file" id="image" name="DH51800367_anh" /><br>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <input type="text" id="country" name="DH51800367_quocgia" value="<?php echo $db['country'] ?>" required />
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
