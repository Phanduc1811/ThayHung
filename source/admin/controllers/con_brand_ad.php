...
if ($action == 'storehang') {
    $id = isset($_POST['DH51800367_mahang']) ? $_POST['DH51800367_mahang'] : '';
    $n = isset($_POST['DH51800367_tenhang']) ? $_POST['DH51800367_tenhang'] : '';
    $c = isset($_POST['DH51800367_quocgia']) ? $_POST['DH51800367_quocgia'] : '';
    $a = '';
    if (isset($_FILES['DH51800367_anh'])) {
