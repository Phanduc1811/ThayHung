...
//     if (!isset($_SESSION))
//         session_start();
//     $user = isset($_POST['DH51800367_username']) ? $_POST['DH51800367_username'] : '';
//     $pass = isset($_POST['DH51800367_pass']) ? $_POST['DH51800367_pass'] : '';
...
if ($action == 'signup') {
    if (isset($_POST['btndangky'])) {
        $tdn = $_POST['DH51800367_username'];
        $mk = $_POST['DH51800367_pass'];
        $phone = $_POST['DH51800367_phone'];
        $mail = $_POST['DH51800367_mail'];
        // echo $tdn;
        // echo $mk;
        // echo $gt;
        // exit;
...
if ($action == 'signin') {
    ...
    if (isset($_POST['btndangnhap'])) {
        $ten = $_POST['DH51800367_username'];
        $pass = $_POST['DH51800367_pass'];
