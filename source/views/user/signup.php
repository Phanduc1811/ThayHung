...
<section class="container">
    <div class="wrapper">
        <form class="form-signin" action="index.php?controller=user&action=signup" method="POST">
            ...
            <input type="text" class="form-control" name="DH51800367_phone" placeholder="Phone Number" id="" required="">
            <input type="text" class="form-control" name="DH51800367_mail" placeholder="Email" id="" required="">
