        ...
        ?>
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                    <form action="index.php?controller=cart&action=add" method="post" class="form" method="POST">
                        ...
                        <ul style="display: flex; justify-content: center; align-items: center;">
                            <li style="width: 100%; height: 5em; ">
                                <button style="width: 100%; height: 3em; font-size: 14pt;">
                                    Thêm Vào Giỏ Hàng&nbsp;<i class="fa fa-cart-plus"></i>
